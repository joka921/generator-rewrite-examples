#ifndef GENERATOR_REWRITE_EXAMPLES_INLINE_IOTA_UNIFIED_H
#define GENERATOR_REWRITE_EXAMPLES_INLINE_IOTA_UNIFIED_H
...
/**
 * An inline (stack-allocated) version of the `iota` generator using the
 * unified inline_gen alias.
 */
auto inline_iota_unified(int start, int end) {
  using promise_type = detail::unified_generator_promise<int>;
  ...
  return inline_gen<int, CoroFrame>{InlineHandle<CoroFrame>{CoroFrame::ramp(start, end)}};
}
#endif  // GENERATOR_REWRITE_EXAMPLES_INLINE_IOTA_UNIFIED_H