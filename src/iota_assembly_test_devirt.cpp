...
// This uses the handle's resume() method which calls frame.doStep() directly (line 42 of inline_handle.h)
// instead of going through the iterator which has more overhead
